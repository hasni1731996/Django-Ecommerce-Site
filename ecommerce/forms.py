...
class CreateProductForm(forms.Form):
	categories = [str(cat) for cat in Product_Category.objects.all()]
	name = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control'}))
	category = forms.CharField(widget=forms.Select(attrs={'class':'form-control'}, choices=([(cat,cat) for cat in categories])))
